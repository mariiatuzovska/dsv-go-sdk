# DsvLogSearchResponse

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Cursor** | **string** | Cursor to next batch of results | [optional] [default to null]
**Data** | [**[]DsvAudit**](Audit.md) | List of matching records | [optional] [default to null]
...
**TotalItems** | **int64** | Number of all items that match the criteria. | [optional] [default to null]
