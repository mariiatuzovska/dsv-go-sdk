...
func (m *Policy) validatePermissionDocument(formats strfmt.Registry) error {
...
func (m *Policy) contextValidatePermissionDocument(ctx context.Context, formats strfmt.Registry) error {
