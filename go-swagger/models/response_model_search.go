...
func (m *ResponseModelSearch) validateData(formats strfmt.Registry) error {
...
func (m *ResponseModelSearch) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
