...
func (m *DocumentVersion) validateData(formats strfmt.Registry) error {
...
func (m *DocumentVersion) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
