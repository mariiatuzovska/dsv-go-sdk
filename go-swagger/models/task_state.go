...
func (m *TaskState) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *TaskState) validateResults(formats strfmt.Registry) error {
...
func (m *TaskState) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
