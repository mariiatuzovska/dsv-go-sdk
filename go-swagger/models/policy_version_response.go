...
func (m *PolicyVersionResponse) validateData(formats strfmt.Registry) error {
...
func (m *PolicyVersionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
