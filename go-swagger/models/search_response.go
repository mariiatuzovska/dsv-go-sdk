...
func (m *SearchResponse) validateData(formats strfmt.Registry) error {
...
func (m *SearchResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
