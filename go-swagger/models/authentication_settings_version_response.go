...
func (m *AuthenticationSettingsVersionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AuthenticationSettingsVersionResponse) validateData(formats strfmt.Registry) error {
...
func (m *AuthenticationSettingsVersionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AuthenticationSettingsVersionResponse) UnmarshalBinary(b []byte) error {
	var res AuthenticationSettingsVersionResponse
