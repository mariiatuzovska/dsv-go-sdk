...
func (o *GetPolicyOK) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyOK  %+v", 200, o.Payload)
}
...
func (o *GetPolicyBadRequest) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetPolicyUnauthorized) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetPolicyForbidden) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyForbidden  %+v", 403, o.Payload)
}
...
func (o *GetPolicyNotFound) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyNotFound  %+v", 404, o.Payload)
}
...
func (o *GetPolicyInternalServerError) Error() string {
	return fmt.Sprintf("[GET /config/policies/{path}][%d] getPolicyInternalServerError  %+v", 500, o.Payload)
}
