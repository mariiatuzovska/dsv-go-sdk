...
func (o *DeletePolicyOK) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyOK  %+v", 200, o.Payload)
}
...
func (o *DeletePolicyNoContent) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyNoContent ", 204)
}
...
func (o *DeletePolicyBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeletePolicyUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeletePolicyForbidden) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyForbidden  %+v", 403, o.Payload)
}
...
func (o *DeletePolicyNotFound) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyNotFound  %+v", 404, o.Payload)
}
...
func (o *DeletePolicyInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /config/policies/{path}][%d] deletePolicyInternalServerError  %+v", 500, o.Payload)
}
