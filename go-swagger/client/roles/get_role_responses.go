...
func (o *GetRoleOK) Error() string {
	return fmt.Sprintf("[GET /roles/{name}][%d] getRoleOK  %+v", 200, o.Payload)
}
...
func (o *GetRoleBadRequest) Error() string {
	return fmt.Sprintf("[GET /roles/{name}][%d] getRoleBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetRoleNotFound) Error() string {
	return fmt.Sprintf("[GET /roles/{name}][%d] getRoleNotFound  %+v", 404, o.Payload)
}
...
func (o *GetRoleInternalServerError) Error() string {
	return fmt.Sprintf("[GET /roles/{name}][%d] getRoleInternalServerError  %+v", 500, o.Payload)
}
