...
func (o *DeleteRoleOK) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleOK  %+v", 200, o.Payload)
}
...
func (o *DeleteRoleBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteRoleUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteRoleForbidden) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteRoleNotFound) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteRoleInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /roles/{name}][%d] deleteRoleInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteRoleInternalServerError) GetPayload() *models.HTTPError {
	return o.Payload
}
