...
func (o *DeleteUserOK) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserOK  %+v", 200, o.Payload)
}
...
func (o *DeleteUserNoContent) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserNoContent ", 204)
}
...
func (o *DeleteUserBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteUserUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteUserForbidden) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteUserNotFound) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteUserInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /users/{name}][%d] deleteUserInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteUserInternalServerError) GetPayload() *models.HTTPError {
	return o.Payload
}
