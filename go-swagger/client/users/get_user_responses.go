...
func (o *GetUserBadRequest) Error() string {
	return fmt.Sprintf("[GET /users/{name}][%d] getUserBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetUserNotFound) Error() string {
	return fmt.Sprintf("[GET /users/{name}][%d] getUserNotFound  %+v", 404, o.Payload)
}
...
func (o *GetUserInternalServerError) Error() string {
	return fmt.Sprintf("[GET /users/{name}][%d] getUserInternalServerError  %+v", 500, o.Payload)
}
